...
// v2.5.0：指南数据提取至共享文件（首页「岛上指南」与本页共用，含 reward 字段）
import { PROFILE_GUIDE_SECTIONS } from '@/data/islandGuide'
...
// ─── 静屿使用指南（v2.5.0：数据移至 @/data/islandGuide，与首页「岛上指南」共用）───
    ...
    <template v-if="profile">
      ...
      <section class="guide-section">
        ...
        <div class="guide-list">
          <div
            v-for="(s, i) in PROFILE_GUIDE_SECTIONS"
            :key="i"
