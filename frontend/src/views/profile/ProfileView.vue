...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    desc: '落叶归根，化作春泥换花种。',
    details: [
      '用落叶兑换花种（向日葵、竹子、梅花、兰花等 12 种植物）。',
      '落叶来源：花田里枯萎的花朵拾取后转化得到。',
      '用露水兑换装扮（竹编帽、油纸伞、蓑衣、乌篷船、鱼竿、橘猫、白鹤等）。',
  ...
  },
  {
    ...
    details: [
      '花种从花坊兑换后自动种入花田，经历种子 → 发芽 → 花苞 → 盛开 → 枯萎的完整周期。',
      '浇水消耗 1 露水，每朵花需要浇一定次数才能进入下一阶段。',
      '盛开后不再需要浇水，7 天后未浇水会枯萎。',
      '枯萎后可拾取化作落叶（落叶又能在花坊换新花种 —— 落叶归根循环）。',
      '种满 10 朵花自动获得「花田主人」徽章。',
    ],
  },
  {
    icon: '👤', title: '我的',
      ...
      <section class="quick-section">
        ...
        <div class="quick-grid">
          ...
          <button class="quick-card card" @click="goShop">
            <span class="quick-card__emoji"><EmojiIcon emoji="🍂" /></span>
            <span class="quick-card__label">花坊</span>
          </button>
